...
function ToastClose({
    ...
    return (
        <ToastPrimitive.Close
            ...
            render={render}
            className={cn(
                "relative shrink-0 !border-0 after:absolute after:-inset-2 after:content-[''] hover:text-foreground",
                className,
            )}
            {...props}
        >
